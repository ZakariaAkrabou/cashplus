        ...
        <div class="w-full max-w-6xl grid lg:grid-cols-2 gap-4">
            <div class="bg-[#002B2F] p-10 rounded-3xl border border-gray-700 shadow-xl text-white w-full">
                <div class="flex flex-col items-center mb-8">
                    <img src="images/logo.svg" alt="CASHPLUS Logo" class="h-16 mb-4">
                    <h2 class="text-3xl font-bold">Create your Account</h2>
                    <p class="text-gray-400 text-center max-w-sm mt-2">Enter your information to create new account</p>
                </div>
                <form action="register" method="post" class="space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="relative">
                            <i class="fas fa-user absolute left-4 top-1/2 transform -translate-y-1/2 text-[#C3D2D7] text-lg"></i>
                    ...
                    <div class="flex items-center gap-4 mt-6">
                        <a href ="${pageContext.request.contextPath}/login"
                            class="flex-1 bg-white text-black font-bold py-3 rounded-lg shadow-md hover:bg-gray-200 text-center">Login <i class="fas fa-sign-in-alt"></i></a>
                        <button type="submit"
                            class="flex-1 bg-[#165D75] text-white font-bold py-3 rounded-lg shadow-md hover:bg-[#12708A] text-center">Sign In <i class="fas fa-sign-in-alt"></i></button>
                    </div>
                </form>
